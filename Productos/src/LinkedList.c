...
int ll_containsAll(LinkedList* this,LinkedList* this2)
{
    ...
    void* pElemAux;
    int contCA = 0;
    //soy conciente de que hacerlo con un contador
 //   es complicarme la vida cuando lo puedo definir antes como uno y
	//si es cdero que haga break, pero lo entendia mas asi
